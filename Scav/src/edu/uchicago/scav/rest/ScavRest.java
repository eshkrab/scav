...
public class ScavRest
{
    ...
    public ScavRest(String aHostName)
    {
    ...
    public JSONObject CreateUser(String aCnetID, String aPassword, String aTeam) {
        try {
            JSONObject myObject = new JSONObject().put("cnetid", aCnetID)
    ...
    public JSONObject CreateTeam(String aTeam) {
        try {
            JSONObject myObject = new JSONObject().put("team", aTeam);
    ...
    public JSONObject CreateItem(String aItem, String aDescription) {
        try {
            JSONObject myObject = new JSONObject().put("item", aItem)
    ...
    public List<Item> GetItems() {
        JSONObject myObject = MakeGetRequest(aHostName, theGetItemsAddress);
        Iterator myKeys = myObject.keys();
        List<Item> myItems = new ArrayList<Item>();

        try {
            while(myKeys.hasNext()) {
                String myItemName = (String)myKeys.next();
                myItems.add(new Item(myItemName, (String) myObject.get(myItemName)));
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
