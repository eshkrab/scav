...
public class Deviceinfoendpoint extends AbstractGoogleJsonClient {
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<edu.uchicago.scav.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, edu.uchicago.scav.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected RemoveDeviceInfo(String id) {
      super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo.class);
      this.id = Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, edu.uchicago.scav.deviceinfoendpoint.model.DeviceInfo.class);
    }
