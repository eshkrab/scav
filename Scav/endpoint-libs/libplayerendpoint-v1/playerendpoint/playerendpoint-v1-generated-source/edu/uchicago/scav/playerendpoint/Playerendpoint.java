...
public class Playerendpoint extends AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetPlayer getPlayer(Long id) throws java.io.IOException {
  ...
  public class GetPlayer extends PlayerendpointRequest<edu.uchicago.scav.playerendpoint.model.Player> {
    ...
    public GetPlayer setId(Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public RemovePlayer removePlayer(Long id) throws java.io.IOException {
  ...
  public class RemovePlayer extends PlayerendpointRequest<edu.uchicago.scav.playerendpoint.model.Player> {
     ...
     * @since 1.13
     */
    protected RemovePlayer(Long id) {
    ...
    public RemovePlayer setId(Long id) {
      this.id = id;
      return this;
    }
